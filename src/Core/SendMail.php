...
class SendMail
{
    public function enviar(string $paraNome, string $paraEmail, string $assunto, string $mensagem)
    {
        ...
        try {
            ...
            $mail->Body    = $mensagem;
            $mail->AltBody = 'Esta mensagem esta formatada com HTML, abra no navegador';
